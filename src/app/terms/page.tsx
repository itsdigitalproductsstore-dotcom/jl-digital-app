...
export default async function TermsPage() {
  ...
  const defaultContent = `باستخدامك لموقع JL Digital Marketing أو شرائك لأي من خدماتنا أو دوراتنا أو منتجاتنا الرقمية، فإنك تقر بأنك قرأت هذه الشروط وفهمتها ووافقت على الالتزام بها. إذا لم توافق على أي جزء منها، يُرجى التوقف عن استخدام الموقع والخدمات.
...
5. الحقوق الفكرية
- جميع المحتويات المعروضة على الموقع مملوكة لـ JL Digital Marketing.
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 sm:px-12 py-24 w-full max-w-4xl mx-auto">
        <div className="space-y-8">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight">
            الشروط والأحكام – JL Digital Marketing
          </h1>
