...
export default async function AboutPage() {
  ...
  const title = content?.about_title || 'BAYA BUSINESS';
  const aboutText = content?.about_text || `نحن BAYA BUSINESS، وكالة متخصصة في حلول التسويق الرقمي وبناء العلامات التجارية القوية الموجّهة لأصحاب الأعمال وروّاد المشاريع الباحثين عن نمو حقيقي وعائد ملموس على الاستثمار.
...
في BAYA BUSINESS، ننظر إلى التسويق بوصفه شراكة طويلة الأمد، نلتزم فيها بالشفافية، ودقة الأرقام، وتطوير الأداء، بما يضمن للعميل منظومة تسويق رقمية مستقرة وقابلة للتوسع.`;
