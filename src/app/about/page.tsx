...
export default async function AboutPage() {
  ...
  const title = content?.about_title || 'BAYYA BUSINESS';
  const aboutText = content?.about_text || `نحن BAYYA BUSINESS، وكالة متخصصة في حلول التسويق الرقمي وبناء العلامات التجارية القوية الموجّهة لأصحاب الأعمال وروّاد المشاريع الباحثين عن نمو حقيقي وعائد ملموس على الاستثمار.

نعمل تحت قيادة الأستاذ فرج وجاسم محمد وليث أحمد على تصميم وتنفيذ استراتيجيات تسويقية متكاملة، تجمع بين التخطيط الدقيق، وصياغة الرسائل الإعلانية الاحترافية، وبناء مسارات تسويق (Funnels) مدروسة، بهدف تحويل التفاعل إلى عملاء حقيقيين وعقود مبيعات مستمرة.
...
في BAYYA BUSINESS، ننظر إلى التسويق بوصفه شراكة طويلة الأمد، نلتزم فيها بالشفافية، ودقة الأرقام، وتطوير الأداء، بما يضمن للعميل منظومة تسويق رقمية مستقرة وقابلة للتوسع.`;
